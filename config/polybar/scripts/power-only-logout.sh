...
opened_text="$button_pre$button_font$button%{T-}$suffix$separator$logout_pre$logout"
animation_json="{\"Concatenation\":[{\"Tag\":{\"prefix\":\"$button_pre\",\"suffix\":\"$suffix\",\"content\":{\"Tag\":{\"prefix\":\"$button_font\",\"suffix\":\"%{T-}\",\"content\":{\"Raw\":\"$button\"}}}}},{\"Raw\":\"$separator\"},{\"Tag\":{\"prefix\":\"$logout_pre\",\"suffix\":\"$suffix\",\"content\":{\"Raw\":\"$logout\"}}}]}"
